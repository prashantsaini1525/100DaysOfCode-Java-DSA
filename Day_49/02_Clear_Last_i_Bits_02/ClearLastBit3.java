...
public class ClearLastBit3 {

    public static int clearLastIBits(int n, int i) {
        if (i <= 0) {
            return n; // If i is 0 or negative, return n unchanged
        }
        if (i >= 32) {
            return 0; // If i is greater than 31, return 0 since we can't clear more than 31 bits in an int
        }
